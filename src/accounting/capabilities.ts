...
export const CAPABILITIES: Capability[] = [
    ...
    { id: 'inflacion', label: 'Ajuste por inflación (RT 54 TO RT 59)', status: 'PARTIAL', detail: 'Pre-cierre guiado con aplicabilidad documentada, anticuación por cuenta, índices versionados, secuencia reexpresión-medición, guardia de doble ajuste, RECPAM conciliado por dos vías y papel de trabajo exportable. Requiere índices oficiales cargados por el usuario y validación profesional para uso real.' },
