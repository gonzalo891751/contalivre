...
export const CAPABILITIES: Capability[] = [
    ...
    { id: 'efe', label: 'Estado de Flujo de Efectivo', status: 'PARTIAL', detail: 'Métodos directo e indirecto conciliados con clasificación estructural; EFE en moneda de cierre pendiente (depende del ajuste por inflación aplicado al juego completo).' },
