    ...
    if (view === 'PREPARACION') {
        ...
        return (
            <div>
                {viewSwitch}
                {/*
                  * Integración 2G.1 + 2H. Este conmutador es EXACTAMENTE el que se veía
                  * roto como "Moneda nominalMoneda de cierre": existe sólo en la vista de
                  * Preparación, que llegó con 2G.1, y su CSS vivía en efeStyles, que esta
                  * rama omitía. Se conservan las dos cosas: la funcionalidad de 2G.1
                  * (preparación reexpresada a moneda de cierre) y la corrección de 2H
                  * (SegmentedControl con CSS global + efeStyles presente en esta rama).
                  */}
                <div className="efe-toolbar" style={{ marginBottom: 12 }}>
                    <SegmentedControl<Currency>
                        ...
                        testId="efe-prep-expresion"
                        options={[
                            { value: 'NOMINAL', label: 'Moneda nominal' },
                            {
                                value: 'CLOSING',
                                label: 'Moneda de cierre',
                                disabled: !prepRestatedAvailable,
                                disabledReason: !prepRestatedAvailable
                                    ? 'Cargá un set de índices para ver la preparación en moneda de cierre'
                                    : undefined,
                            },
                        ]}
                    />
